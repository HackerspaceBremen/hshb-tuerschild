...
unsigned long Interval = 100; //Interval für Lauflicht in ms
...
void loop ()
{
    ...
    if((ms - msLast) >= Interval)
    {
        ...
        if(!digitalRead(BOX1SCHALTER))
        {
            ...
            strip.setPixelColor(BOX1START+i%LEDPROBOX,cGreen);
        }
        else
        {
        ...
        if(!digitalRead(BOX2SCHALTER))
        {
            ...
            strip.setPixelColor(BOX2START+LEDPROBOX-1-i%LEDPROBOX,cOrange);
        }
        else
        {
        ...
        if(!digitalRead(BOX3SCHALTER))
        {
            ...
            strip.setPixelColor(BOX3START+i%LEDPROBOX,cYellow);
        }
        else
        {
